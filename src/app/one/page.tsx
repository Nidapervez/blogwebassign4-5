      ...
      <div className="container mx-auto py-24 px-5">
        <div className="flex flex-col items-center">
          <div className="pl-40 h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden hover:border-blue-800 hover:border-4">
            <Image src={image} alt="Blog Image" height={400} width={800} className="object-cover" />
            <div className="p-6">
              ...
              <p className="leading-relaxed mb-3">
                In today dynamic world, various professions contribute to the fabric of society, each playing a pivotal role in its functioning. From the creative realms of arts and media to the meticulous fields of science and technology, each profession has unique attributes that make it essential.
              </p>
              <p className="leading-relaxed mb-3">
